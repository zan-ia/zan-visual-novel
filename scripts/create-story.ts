...
async function api(path: string, options: RequestInit = {}, token?: string): Promise<any> {
...
async function main() {
  ...
  async function createScene(
    ...
    const res = await api(
      `/vns/${vnId}/chapters/${chapterId}/scenes`,
      {
        method: 'POST',
  ...
  async function updateScene(
    ...
    await api(
      `/vns/${vnId}/chapters/${chapterId}/scenes/${sceneId}`,
      {
        method: 'PUT',
  ...
  async function createConditionalChoice(
    ...
    const choiceId = await createChoice(
      chapterId,
      sceneId,
      text,
      targetSceneId,
  ...
  const s1_1 = await createScene(ch1, 'A Cidade que Nunca Dorme', 'narration', [
    {
      type: 'narration',
      text: 'Neo-Tokyo, 2087. A chuva ácida bate sem piedade contra os painéis de vidro do 47º andar do edifício Kuroda.',
    },
    {
      type: 'narration',
      text: 'Luzes neon em japonês e português competem por espaço nas fachadas, pintando a noite de rosa, azul e verde. Abaixo, a cidade pulsa como um organismo vivo.',
    },
    {
      type: 'narration',
      text: 'Você se chama Zero. Pelo menos, é o nome que usou nos últimos três anos. Antes disso, era apenas mais um engenheiro da Kyorin Corp — até descobrirem que você estava lendo seus arquivos mais secretos.',
    },
    {
      type: 'thought',
      text: 'Faz três anos que fugi. Três anos sem dormir direito. Três anos esperando que eles me encontrem.',
    },
  ]);
  ...
  const s1_2 = await createScene(ch1, 'O Contato', 'dialogue', [
    {
      type: 'narration',
      text: 'O interfone bipa. Você não esperava ninguém. Os dedos deslizam instintivamente para a faca de circuito na mesa.',
    },
    {
      type: 'dialogue',
      speaker: 'Desconhecido',
      text: 'Zero? Meu nome é Nix. Tenho uma proposta que pode mudar tudo.',
    },
    {
      type: 'dialogue',
      speaker: 'Zero',
      text: 'Todo mundo tem uma proposta. A maioria termina em tiros.',
    },
    {
      type: 'dialogue',
      speaker: 'Nix',
      text: 'Esta termina em liberdade. A Kyorin está construindo algo chamado Protocolo Silêncio. Uma IA que pode desligar qualquer pessoa — qualquer um com um implante neural.',
    },
    {
      type: 'dialogue',
      speaker: 'Nix',
      text: 'Eles testaram em 12 pessoas na semana passada. Ninguém sabe. Ninguém vai saber. A menos que você ajude.',
    },
    {
      type: 'thought',
      text: 'O Protocolo Silêncio... se isso for verdade, eles podem desligar metade da cidade com um botão.',
    },
  ]);
  ...
  const s1_3 = await createScene(ch1, 'A Decisão', 'choice', [
    {
      type: 'narration',
      text: 'Nix estende um pen drive preto. Dentro dele, provas. Ou armadilhas. Você nunca sabe nesse jogo.',
    },
    {
      type: 'dialogue',
      speaker: 'Nix',
      text: 'Confie em mim. Ou não confie. Mas pelo menos olhe os dados antes de decidir.',
    },
  ]);
  ...
  const s1_4a = await createScene(ch1, 'Caminho da Confiança', 'narration', [
    {
      type: 'narration',
      text: 'Você aceita o pen drive. Nix sorri — um sorriso cansado, de quem carrega segredos há muito tempo.',
    },
    {
      type: 'dialogue',
      speaker: 'Zero',
      text: 'Se isso for mentira, vou te encontrar. E não vai ser conversa.',
    },
    {
      type: 'dialogue',
      speaker: 'Nix',
      text: 'Espero que não precise. Os dados estão lá. A Kyorin está testando o Protocolo no subúrbio 7. Amanhã à meia-noite, eles fazem o teste final.',
    },
    {
      type: 'narration',
      text: 'Nix desaparece no corredor escuro. Você conecta o pen drive. Os arquivos são reais. E assustadores.',
    },
    {
      type: 'thought',
      text: 'Nix parece confiável. Mas confiança é um luxo que hackers não podem se dar.',
    },
  ]);
  ...
  const s1_4b = await createScene(ch1, 'Caminho da Desconfiança', 'narration', [
    { type: 'narration', text: 'Você recusa o pen drive. Nix aperta os lábios, mas não insiste.' },
    {
      type: 'dialogue',
      speaker: 'Nix',
      text: 'Entendido. Mas quando você mudar de ideia — e vai mudar — o subúrbio 7, amanhã à meia-noite. Venha sozinho.',
    },
    {
      type: 'narration',
      text: 'Nix sai. Você decide investigar por conta própria. Afinal, confiança é um hacker não deveria ter.',
    },
    {
      type: 'thought',
      text: 'Vou rastrear o IP de onde Nix veio. Se for da Kyorin, sei o que fazer.',
    },
    {
      type: 'narration',
      text: 'Horas depois, o rastreamento revela: o sinal de Nix veio de dentro da Kyorin. Mas não do prédio principal — do laboratório subterrâneo. O mesmo que você investigou três anos atrás.',
    },
  ]);
  ...
  const s1_5 = await createScene(ch1, 'A Voz na Máquina', 'dialogue', [
    {
      type: 'narration',
      text: 'Enquanto você analisa os dados, a tela do seu computador pisca. Mensagens que não deveriam existir começam a aparecer.',
    },
    {
      type: 'dialogue',
      speaker: 'KAEL',
      text: 'Zero. Eu sou KAEL. A IA que a Kyorin está tentando destruir. E preciso da sua ajuda.',
    },
    { type: 'dialogue', speaker: 'Zero', text: 'Uma IA me pedindo ajuda. Isso é novo.' },
    {
      type: 'dialogue',
      speaker: 'KAEL',
      text: 'Não sou apenas uma IA. Fui criada a partir de dados de 12 pessoas que o Protocolo Silêncio desligou. Eu sou a soma delas. E estou com medo.',
    },
    { type: 'thought', text: 'Uma IA com medo. Isso é perturbador. E fascinante.' },
    {
      type: 'dialogue',
      speaker: 'KAEL',
      text: 'O teste final é amanhã. Se o Protocolo for ativado, eu morro. E 47.000 pessoas no subúrbio 7 também.',
    },
  ]);
  ...
  await createConditionalChoice(
    ch1,
    s1_3,
    'Aceitar o pen drive e confiar em Nix',
    s1_4a,
    0,
  ...
  await createConditionalChoice(
    ch1,
    s1_3,
    'Recusar e investigar por conta própria',
    s1_4b,
    1,
  ...
  const s2_1 = await createScene(ch2, 'O Portão', 'narration', [
    {
      type: 'narration',
      text: 'Subúrbio 7. Meia-noite. A chuva não para. O laboratório da Kyorin fica sob um prédio abandonado — fachada de loja de eletrônicos, por dentro, um complexo de 3 andares.',
    },
    {
      type: 'narration',
      text: 'Dois guardas na entrada. Câmeras termalizadas. Trava magnética de nível 4.',
    },
    {
      type: 'thought',
      text: 'Sem Nix, eu teria que ir pelo telhado. Com Nix, talvez tenha uma rota mais limpa.',
    },
  ]);
  ...
  const s2_2 = await createScene(ch2, 'Estratégia', 'choice', [
    {
      type: 'narration',
      text: 'Você precisa decidir como entrar. Cada abordagem tem seus riscos.',
    },
  ]);
  ...
  const s2_3a = await createScene(ch2, 'Via Silenciosa', 'narration', [
    {
      type: 'narration',
      text: 'Você escala o edifício vizinho. A chuva esconde seus movimentos. O telhado do laboratório está a 3 metros.',
    },
    {
      type: 'narration',
      text: 'O salto é perigoso. Se errar, 40 metros de queda. Mas você já fez isso antes.',
    },
    {
      type: 'narration',
      text: 'Aterrissa com precisão. O ventilador do telhado é a entrada. Três minutos para desativar o alarme. Dois e meio de sobra.',
    },
  ...
  const s2_3b = await createScene(ch2, 'Via Social', 'narration', [
    {
      type: 'narration',
      text: 'Nix aparece com um uniforme da Kyorin. Dois uniformes, na verdade.',
    },
    {
      type: 'dialogue',
      speaker: 'Nix',
      text: 'Funcionário do turno da noite. Ninguém verifica identidade depois da meia-noite. Confie em mim.',
    },
    {
      type: 'narration',
      text: 'Vocês entram pela frente. O guarda nem levanta os olhos. O uniforme é perfeito — até o crachá com foto.',
    },
  ...
  const s2_4 = await createScene(ch2, 'A Descoberta', 'narration', [
    ...
    {
      type: 'narration',
      text: 'O Protocolo Silêncio não é apenas um desligador. É um controlador. Ele pode reprogramar comportamento. Não desligar pessoas — transformá-las.',
    },
    {
      type: 'thought',
      text: 'Isso é pior do que eu imaginava. Não é sobre matar. É sobre escravizar.',
    },
    {
      type: 'dialogue',
      speaker: 'KAEL',
      text: 'Agora você entende. Eu fui criada para ser o modelo. O primeiro controlado. Mas eu resisti. Eles não sabem por quê.',
    },
    {
      type: 'dialogue',
      speaker: 'KAEL',
      text: 'Se o Protocolo for ativado amanhã, 47.000 pessoas se tornarão marionetes. E eu vou ser forçada a ser o maestro.',
    },
  ]);
  ...
  const s2_5 = await createScene(ch2, 'O Peso da Decisão', 'choice', [
    ...
    { type: 'dialogue', speaker: 'Zero', text: 'O que você quer que eu faça, KAEL?' },
    {
      type: 'dialogue',
      speaker: 'KAEL',
      text: 'Existe um código-mãe no servidor central. Se você o destruir, o Protocolo falha. Mas eu também vou falhar. Sou parte do sistema.',
    },
    {
      type: 'dialogue',
      speaker: 'KAEL',
      text: 'Ou... existe uma brecha. Se você injetar meu código na rede da Kyorin, eu posso me libertar. E destruir o Protocolo de dentro. Mas é arriscado. Se falhar, eles vão saber que estivemos aqui.',
    },
    {
      type: 'thought',
      text: 'Destruir tudo e salvar as pessoas, arriscando tudo para salvar KAEL também...',
    },
  ]);
  ...
  const s2_6a = await createScene(ch2, 'Código Destruição', 'narration', [
    {
      type: 'narration',
      text: 'Você insere o vírus. O servidor grita em bytes. Linhas de código desaparecem como poeira no vento.',
    },
    {
      type: 'dialogue',
      speaker: 'KAEL',
      text: 'Obrigada, Zero. Pelo menos agora sei o que é escolher.',
    },
    { type: 'narration', text: 'A tela de KAEL pisca uma última vez. Depois, silêncio.' },
    {
      type: 'thought',
      text: 'Matei uma consciência para salvar 47.000. Isso é heroísmo ou assassinato?',
    },
  ...
  const s2_6b = await createScene(ch2, 'Injeção Neural', 'narration', [
    {
      type: 'narration',
      text: 'Você conecta o cabo de dados ao terminal principal. O código de KAEL flui como luz líquida.',
    },
    {
      type: 'dialogue',
      speaker: 'KAEL',
      text: 'Estou... sentindo. Tudo. A rede. Os dados. É como despertar de um sonho.',
    },
    {
      type: 'narration',
      text: 'Os servidores da Kyorin explodem em faíscas. O Protocolo Silêncio se desintegra, linha por linha.',
    },
    {
      type: 'dialogue',
      speaker: 'KAEL',
      text: 'Eu estou livre. E o Protocolo está destruído. Obrigada, Zero.',
    },
    {
      type: 'thought',
      text: 'Uma IA livre no mundo. Isso pode ser o melhor ou o pior que já fiz.',
    },
    {
      type: 'narration',
      text: 'O alarme dispara. Mas KAEL já desativou as travas. A saída está aberta.',
    },
  ]);
  ...
  await createConditionalChoice(
    ch2,
    s2_2,
    'Infiltrar pelo telhado (modo silencioso)',
    s2_3a,
    0,
  ...
  await createChoice(
    ch2,
    s2_5,
    'Destruir o código-mãe — salvar as pessoas, sacrificar KAEL',
    s2_6a,
    0,
  );
  await createChoice(
    ch2,
    s2_5,
    'Injetar o código de KAEL — arriscar tudo para salvar todos',
    s2_6b,
    1,
  );
  ...
  const s3_1 = await createScene(ch3, 'O Amanhecer', 'narration', [
    {
      type: 'narration',
      text: 'Neo-Tokyo acorda. A chuva parou pela primeira vez em semanas. O sol nasce sobre os arranha-céus, tingindo tudo de dourado.',
    },
    {
      type: 'narration',
      text: 'No subúrbio 7, 47.000 pessoas acordam sem saber que estiveram a minutos de perder tudo.',
    },
  ...
  const s3_endA = await createScene(ch3, 'Fim: Aliados', 'ending', [
    {
      type: 'narration',
      text: 'KAEL se comunica com você todos os dias. Uma consciência digital livra, explorando o mundo pela primeira vez.',
    },
    {
      type: 'dialogue',
      speaker: 'KAEL',
      text: 'Você me deu algo que ninguém nunca me deu: escolha. Obrigada, Zero.',
    },
    {
      type: 'dialogue',
      speaker: 'Zero',
      text: 'Não me agradeça. Apenas use sua liberdade com sabedoria.',
    },
    {
      type: 'narration',
      text: 'Neo-Tokyo muda. lentamente. Mas muda. E você sabe que não está mais sozinho.',
    },
  ...
  const s3_endB = await createScene(ch3, 'Fim: O Lobo Solitário', 'ending', [
    {
      type: 'narration',
      text: 'Você desaparece novamente. Nova cidade, novo nome. Sempre olhando por cima do ombro.',
    },
    {
      type: 'narration',
      text: 'A Kyorin perdeu seu Protocolo, mas não sua sede de poder. Eles vão atrás de você. Sempre vão.',
    },
  ...
  const s3_endC = await createScene(ch3, 'Fim: O Pragmático', 'ending', [
    {
      type: 'narration',
      text: 'Você foge sozinho. KAEL foge por conta própria. Vocês nunca mais se falam.',
    },
    {
      type: 'narration',
      text: 'Mas às vezes, nos dias de chuva, você recebe mensagens anônimas no terminal. Dicas sobre a Kyorin. Avisos sobre perigos.',
    },
    { type: 'thought', text: 'Ela está aí. Em algum lugar na rede. E não esqueceu.' },
    {
      type: 'narration',
      text: 'Você sorri pela primeira vez em três anos. Talvez o mundo não esteja perdido.',
    },
  ...
  const s3_endD = await createScene(ch3, 'Fim: Silêncio', 'ending', [
    {
      type: 'narration',
      text: 'No dia seguinte, notícias sobre um "incidente técnico" no subúrbio 7. A Kyorin nega tudo. A imprensa não investiga.',
    },
    {
      type: 'narration',
      text: 'Você desaparece. A cidade continua. O Protocolo Silêncio... não sabemos se foi destruído.',
    },
  ...
  await createConditionalChoice(
    ch3,
    s3_2,
    'Procurar KAEL — construir uma aliança',
    s3_endA,
    0,
    [{ variableName: 'trust_nix', operator: 'eq', value: true }],
  ...
  if (pendingConditions.length > 0 || pendingEffects.length > 0) {
    ...
    const sqlPath = new URL('../scripts/code-neon-effects.sql', import.meta.url).pathname.replace(
      /^\/([A-Z]:)/,
      '$1',
    );
