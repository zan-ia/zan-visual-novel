...
const ch3Scenes: NeonSeedScene[] = [
  ...
  },
  {
    ...
    content: [
      ...
      {
        type: 'narration',
        text: 'trust_ana >= 2: Quando Zara se aproxima, ele não parece surpreso. "Ana me avisou que você viria. Senta."',
      },
      {
        type: 'narration',
        text: 'trust_ana < 2: Quando Zara se aproxima, a mão dele vai para a arma. "Engenheira Oliveira. Você tem coragem de aparecer aqui."',
      },
      {
        type: 'dialogue',
        speaker: 'Marcos',
        text: 'Eu sei quem você é. Sei o que você carrega. E sei que a OmniTech quer sua cabeça. A pergunta é: por que eu deveria me importar?',
      },
      {
        type: 'dialogue',
        speaker: 'Zara',
        text: 'Porque você ainda usa o uniforme. Ainda que amassado. Ainda que sujo. Alguma parte de você ainda acredita.',
      },
      {
        type: 'narration',
      ...
      },
      {
        type: 'dialogue',
        speaker: 'Marcos',
        text: 'Maldita Ana. Sempre soube que ela ia me enfiar em alguma encrenca.',
      },
    ],
  },
  {
...
export async function seedNeonRefugio(
  ...
  console.log(
    `   ✅ ${chaptersCreated} capítulos criados (${neonRefugioChapters.length} no total)`,
  );
  ...
  console.log(
    `   ✅ ${choicesCreated} escolhas criadas (com condições e efeitos) (${neonRefugioChoices.length} no total)`,
  );

  console.log(
    '   💡 NEON REFÚGIO agora tem 3 capítulos jogáveis (Caps 1-3, 23 cenas, 11 escolhas)',
  );
}
