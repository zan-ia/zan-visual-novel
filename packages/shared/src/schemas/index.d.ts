...
export declare const llmModelTypeSchema: z.ZodEnum<
  ['lfm-230m', 'lfm-350m', 'lfm-1.2b-thinking', 'lfm-vl-450m']
>;
export declare const llmGenerateSchema: z.ZodObject<
  {
    ...
    config: z.ZodObject<
      {
        modelType: z.ZodDefault<
          z.ZodEnum<['lfm-230m', 'lfm-350m', 'lfm-1.2b-thinking', 'lfm-vl-450m']>
        >;
